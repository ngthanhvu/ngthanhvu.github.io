...
const navigationItems = [
  { label: "Tổng quan", icon: LayoutDashboard, href: "/dashboard", active: false },
  { label: "Short URL", icon: Link2, href: "/url", active: true },
  { label: "Hồ sơ", icon: UserRound, href: "/profile", active: false }
];
